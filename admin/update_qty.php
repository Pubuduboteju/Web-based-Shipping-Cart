        ...
        <div class="grid_10">
            <div class="box round first">
                ...
                <style type="text/css">
					...
					<tr>
					<td colspan="2" align="center"><input type="submit" name="submit3" value="Update Quantity in Database"></td>
				</tr>
...
mysqli_query($link,"update products SET qty='$_POST[pqty]' where brand = '$_POST[pdesc]' and catgry = '$_POST[pcategory]' ");
