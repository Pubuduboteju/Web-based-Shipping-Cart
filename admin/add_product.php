        ...
        <div class="grid_10">
            <div class="box round first">
                ...
                <style type="text/css">
					...
					<tr>
					<td colspan="2" align="center"><input type="submit" name="submit1" value="Add to the Database"></td>
				</tr>
...
mysqli_query($link,"insert into products(p_name,image,price,brand,catgry,qty) values('$_POST[pnm]','$dst1',$_POST[pprice],'$_POST[pdesc]','$_POST[pcategory]',$_POST[pqty])");
