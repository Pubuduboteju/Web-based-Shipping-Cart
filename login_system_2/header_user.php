	...
	<div id="top-bar" class="container">
		<div class="row">
			<div class="span2 col-md-2" id="logo">
				<a href="index.html" ><img  id="benzlogo" src="../download.jpg" alt=""></a>
			</div>
			...
			<div class="span2 col-md-8" id="user-menu-div">
	        	<ul class="user-menu">				
					<li><a href="#">My Account <img class="user-menu-account-img" src="../img/e180cbe3d456b5f11ab36459ccb56c5a.png"></a></li>
					...
					<nav id="menu" class="pull-right class="navbar navbar-default""> 
	        			<ul >
							...
							<li><a href="./products.html"><img class="menu-logo" src="../img/bmw-logo-F4A92B9BC1-seeklogo.com.png"> BMW</a>
                                	<ul>
                                    	<li><a href="./products.html">1 Series</a></li>
                                    	<li><a href="./products.html">2 Series</a></li>
							...
							<li><a href="./products.html"><img class="menu-logo-lam" src="../img/Lamborghini-logo-1920x1080.png"> Lamborghini</a>
                                	<ul>
                                    	<li><a href="./products.html">Aventador</a></li>
                                    	<li><a href="./products.html">Gallardo</a></li>
							...
							<li><a href="./products.html"><img class="menu-logo-fer" src="../img/Ferrari-emblem-1920x1080.png"> Ferrari</a>
                                	<ul>
                                    	...
                                    	<li><a href="./products.html">Moterbickes</a></li>
                                    	<li><a href="./products.html">Vans</a></li>
                                    	<li><a href="./products.html">Three Wheelers</a></li>
                                    	<li><a href="./products.html">Buses</a></li>
                                    	<li><a href="./products.html">Lorries</a></li>
                                	</ul>
                            </li>
