...
<!--<form action="<?php echo $paypal_url;?>/cgi-bin/webscr" method="post" name="buyCredits" id="buyCredits">
    ...
    <input type="hidden" name="business" value="pubuduboteju95-facilitator@gmail.com">
    ...
    <input type="hidden" name="return" value="127.0.0.1/Uni Pro/user/payment_success.php?id=<?php echo $order_id; ?>">
</form>-->
<form action="<?php echo $paypal_url;?>/cgi-bin/webscr" method="post" name="buyCredits" id="buyCredits">
    ...
    <input type="hidden" name="item_number" value="1212">
    <input type="hidden" name="amount" value="<?php echo $pay; ?>">
    <input type="hidden" name="return" value="http://localhost:8083/Uni Pro/user/payment_success.php?id=<?php echo $order_id; ?>">
</form>
<script type="text/javascript">
